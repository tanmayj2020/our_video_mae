...
from engine_for_two_branch import train_one_epoch, validation_one_epoch, final_test, merge
...
def get_model(args):
    ...
    model = modelling_pretrain.__dict__[args.model](
        num_classes_classification=args.nb_classes,
...
def main(args, ds_init):
    ...
    dataset_train, args.nb_classes = build_two_branch_dataset(args)
    dataset_val = None
    dataset_test, _ = build_dataset(args=args)
